...
SELECT max(people_served)
  from  combined_analysis_table
where source_type = 'river'
and province_name =  'Amanzi';
...
WITH province_totals AS (-- This CTE calculates the population of each province
 ...
 --  CRreating TEMPORARY TABLE for town_aggregated_water_access
...
-- towns called amina
 ...
 -- Percentage of taps in broken homes in various provinces
  SELECT 
    province_name,
    town_name,
...
drop view progress;
-- CHECKING THE NUMBER OF uv filters to be replaced
select count(*)
from progress
